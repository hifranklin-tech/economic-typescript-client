...
// @ts-ignore
import type { AttachedDocument } from '../model';
// @ts-ignore
import type { AttachedDocumentCursorResults } from '../model';
// @ts-ignore
import type { ProblemDetails } from '../model';
/**
 * AttachedDocumentsApi - axios parameter creator
 * @export
 */
export const AttachedDocumentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Use this endpoint to attach a PDF to Booked or Draft Entries.
         * @summary Attach PDF
         * @param {number} voucherNumber The number of the voucher that the document is attached to&lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Filterable: eq, ne, lt, lte, gt, gte, in, nin&lt;/p&gt;&lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Sortable: false&lt;/p&gt;
         * @param {string} accountingYear The accounting year of the voucher that the document is attached to&lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Filterable: eq, ne, lt, lte, gt, gte, in, nin&lt;/p&gt;&lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Sortable: false&lt;/p&gt;
         * @param {File} file &lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Filterable: not filterable&lt;/p&gt;&lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Sortable: false&lt;/p&gt;&lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Max allowed file size: 9 MB&lt;/p&gt;&lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Allowed content types: application/pdf (&lt;strong&gt;.pdf&lt;/strong&gt;)&lt;/p&gt;
         * @param {number} [number] The unique number of the attached document&lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Filterable: eq, ne, lt, lte, gt, gte, in, nin&lt;/p&gt;&lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Sortable: true&lt;/p&gt;
         * @param {string | null} [note] The note of the attached document&lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Filterable: not filterable&lt;/p&gt;&lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Sortable: false&lt;/p&gt;
         * @param {number | null} [pageCount] The number of pages of the attached document&lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Filterable: not filterable&lt;/p&gt;&lt;p style&#x3D;\\\&#39;font-style:italic;font-family:monospace;font-size:small;margin:0\\\&#39;&gt;Sortable: false&lt;/p&gt;
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        attachPdfAsync: async (voucherNumber: number, accountingYear: string, file: File, number?: number, note?: string | null, pageCount?: number | null, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'voucherNumber' is not null or undefined
            assertParamExists('attachPdfAsync', 'voucherNumber', voucherNumber)
            // verify required parameter 'accountingYear' is not null or undefined
            assertParamExists('attachPdfAsync', 'accountingYear', accountingYear)
            // verify required parameter 'file' is not null or undefined
            assertParamExists('attachPdfAsync', 'file', file)
            const localVarPath = `/AttachedDocuments`;
            ...
            if (pageCount !== undefined) { 
                localVarFormParams.append('pageCount', pageCount as any);
            }
    
            if (voucherNumber !== undefined) { 
                localVarFormParams.append('voucherNumber', voucherNumber as any);
            }
    
            if (accountingYear !== undefined) { 
                localVarFormParams.append('accountingYear', accountingYear as any);
            }
         ...
         * @summary Delete single AttachedDocument
         * @param {number} number 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteAttachedDocumentById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('deleteAttachedDocumentById', 'number', number)
            const localVarPath = `/AttachedDocuments/{number}`
         ...
         * @summary Retrieve all AttachedDocuments
         * @param {string} [cursor] 
         * @param {string} [filter] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllAttachedDocuments: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/AttachedDocuments`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @summary Retrieve single AttachedDocument
         * @param {number} number 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAttachedDocumentById: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getAttachedDocumentById', 'number', number)
            const localVarPath = `/AttachedDocuments/{number}`
                .replace(`{${"number"}}`, encodeURIComponent(String(number)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @summary Retrieve the number of AttachedDocuments
         * @param {string} [filter] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfAttachedDocuments: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/AttachedDocuments/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @summary Retrieve a page of AttachedDocuments
         * @param {string} [filter] 
         * @param {string} [sort] 
         ...
         * @throws {RequiredError}
         */
        getPageOfAttachedDocuments: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/AttachedDocuments/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @summary Retrieve the pdf file for a single AttachedDocument
         * @param {number} number 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPdfForAttachedDocument: async (number: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'number' is not null or undefined
            assertParamExists('getPdfForAttachedDocument', 'number', number)
            const localVarPath = `/AttachedDocuments/{number}/pdf`
                .replace(`{${"number"}}`, encodeURIComponent(String(number)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
/**
 * AttachedDocumentsApi - functional programming interface
 * @export
 */
export const AttachedDocumentsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = AttachedDocumentsApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to attach a PDF to Booked or Draft Entries.
         * @summary Attach PDF
         ...
         * @throws {RequiredError}
         */
        async attachPdfAsync(voucherNumber: number, accountingYear: string, file: File, number?: number, note?: string | null, pageCount?: number | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.attachPdfAsync(voucherNumber, accountingYear, file, number, note, pageCount, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AttachedDocumentsApi.attachPdfAsync']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async deleteAttachedDocumentById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteAttachedDocumentById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AttachedDocumentsApi.deleteAttachedDocumentById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to retrieve all AttachedDocuments in bulk. <br/>The maximum number of items returned in a single call is defined in the `x-cursor-page-size` extension of the response type. Usually, the size is 1000, but in some cases, where we explicitly state so, it can be smaller than that.<br/>Use the continuation cursor parameter to set the cursor for retrieval of the next set of data.<br/>Please check the [pagination instructions](#section/Retrieving-data/Pagination).
         ...
         * @throws {RequiredError}
         */
        async getAllAttachedDocuments(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AttachedDocumentCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllAttachedDocuments(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AttachedDocumentsApi.getAllAttachedDocuments']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a single AttachedDocument by number.
         ...
         * @throws {RequiredError}
         */
        async getAttachedDocumentById(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AttachedDocument>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAttachedDocumentById(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AttachedDocumentsApi.getAttachedDocumentById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of AttachedDocuments. You can use filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfAttachedDocuments(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfAttachedDocuments(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AttachedDocumentsApi.getNumberOfAttachedDocuments']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of AttachedDocuments.
         ...
         * @throws {RequiredError}
         */
        async getPageOfAttachedDocuments(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AttachedDocument>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfAttachedDocuments(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AttachedDocumentsApi.getPageOfAttachedDocuments']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to retrieve the pdf file for a single AttachedDocument.
         ...
         * @throws {RequiredError}
         */
        async getPdfForAttachedDocument(number: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPdfForAttachedDocument(number, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AttachedDocumentsApi.getPdfForAttachedDocument']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * AttachedDocumentsApi - factory interface
 * @export
 */
export const AttachedDocumentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = AttachedDocumentsApiFp(configuration)
    return {
        /**
         * Use this endpoint to attach a PDF to Booked or Draft Entries.
         * @summary Attach PDF
         * @param {AttachedDocumentsApiAttachPdfAsyncRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        attachPdfAsync(requestParameters: AttachedDocumentsApiAttachPdfAsyncRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.attachPdfAsync(requestParameters.voucherNumber, requestParameters.accountingYear, requestParameters.file, requestParameters.number, requestParameters.note, requestParameters.pageCount, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to delete a single AttachedDocument by number.
         * @summary Delete single AttachedDocument
         * @param {AttachedDocumentsApiDeleteAttachedDocumentByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteAttachedDocumentById(requestParameters: AttachedDocumentsApiDeleteAttachedDocumentByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteAttachedDocumentById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to retrieve all AttachedDocuments in bulk. <br/>The maximum number of items returned in a single call is defined in the `x-cursor-page-size` extension of the response type. Usually, the size is 1000, but in some cases, where we explicitly state so, it can be smaller than that.<br/>Use the continuation cursor parameter to set the cursor for retrieval of the next set of data.<br/>Please check the [pagination instructions](#section/Retrieving-data/Pagination).
         * @summary Retrieve all AttachedDocuments
         * @param {AttachedDocumentsApiGetAllAttachedDocumentsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllAttachedDocuments(requestParameters: AttachedDocumentsApiGetAllAttachedDocumentsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<AttachedDocumentCursorResults> {
            return localVarFp.getAllAttachedDocuments(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a single AttachedDocument by number.
         * @summary Retrieve single AttachedDocument
         * @param {AttachedDocumentsApiGetAttachedDocumentByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAttachedDocumentById(requestParameters: AttachedDocumentsApiGetAttachedDocumentByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<AttachedDocument> {
            return localVarFp.getAttachedDocumentById(requestParameters.number, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of AttachedDocuments. You can use filtering as well.
         * @summary Retrieve the number of AttachedDocuments
         * @param {AttachedDocumentsApiGetNumberOfAttachedDocumentsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfAttachedDocuments(requestParameters: AttachedDocumentsApiGetNumberOfAttachedDocumentsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfAttachedDocuments(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of AttachedDocuments.
         * @summary Retrieve a page of AttachedDocuments
         * @param {AttachedDocumentsApiGetPageOfAttachedDocumentsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfAttachedDocuments(requestParameters: AttachedDocumentsApiGetPageOfAttachedDocumentsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<AttachedDocument>> {
            return localVarFp.getPageOfAttachedDocuments(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to retrieve the pdf file for a single AttachedDocument.
         * @summary Retrieve the pdf file for a single AttachedDocument
         * @param {AttachedDocumentsApiGetPdfForAttachedDocumentRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPdfForAttachedDocument(requestParameters: AttachedDocumentsApiGetPdfForAttachedDocumentRequest, options?: RawAxiosRequestConfig): AxiosPromise<File> {
            return localVarFp.getPdfForAttachedDocument(requestParameters.number, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for attachPdfAsync operation in AttachedDocumentsApi.
 * @export
 * @interface AttachedDocumentsApiAttachPdfAsyncRequest
 */
export interface AttachedDocumentsApiAttachPdfAsyncRequest {
    /**
     ...
     * @type {number}
     * @memberof AttachedDocumentsApiAttachPdfAsync
     */
...
/**
 * Request parameters for deleteAttachedDocumentById operation in AttachedDocumentsApi.
 * @export
 * @interface AttachedDocumentsApiDeleteAttachedDocumentByIdRequest
 */
export interface AttachedDocumentsApiDeleteAttachedDocumentByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof AttachedDocumentsApiDeleteAttachedDocumentById
     */
    readonly number: number
}

/**
 * Request parameters for getAllAttachedDocuments operation in AttachedDocumentsApi.
 * @export
 * @interface AttachedDocumentsApiGetAllAttachedDocumentsRequest
 */
export interface AttachedDocumentsApiGetAllAttachedDocumentsRequest {
    /**
     * 
     * @type {string}
     * @memberof AttachedDocumentsApiGetAllAttachedDocuments
     */
...
/**
 * Request parameters for getAttachedDocumentById operation in AttachedDocumentsApi.
 * @export
 * @interface AttachedDocumentsApiGetAttachedDocumentByIdRequest
 */
export interface AttachedDocumentsApiGetAttachedDocumentByIdRequest {
    /**
     * 
     * @type {number}
     * @memberof AttachedDocumentsApiGetAttachedDocumentById
     */
    readonly number: number
}

/**
 * Request parameters for getNumberOfAttachedDocuments operation in AttachedDocumentsApi.
 * @export
 * @interface AttachedDocumentsApiGetNumberOfAttachedDocumentsRequest
 */
export interface AttachedDocumentsApiGetNumberOfAttachedDocumentsRequest {
    /**
     * 
     * @type {string}
     * @memberof AttachedDocumentsApiGetNumberOfAttachedDocuments
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfAttachedDocuments operation in AttachedDocumentsApi.
 * @export
 * @interface AttachedDocumentsApiGetPageOfAttachedDocumentsRequest
 */
export interface AttachedDocumentsApiGetPageOfAttachedDocumentsRequest {
    /**
     * 
     * @type {string}
     * @memberof AttachedDocumentsApiGetPageOfAttachedDocuments
     */
    readonly filter?: string
...
/**
 * Request parameters for getPdfForAttachedDocument operation in AttachedDocumentsApi.
 * @export
 * @interface AttachedDocumentsApiGetPdfForAttachedDocumentRequest
 */
export interface AttachedDocumentsApiGetPdfForAttachedDocumentRequest {
    /**
     * 
     * @type {number}
     * @memberof AttachedDocumentsApiGetPdfForAttachedDocument
     */
    readonly number: number
}

/**
 * AttachedDocumentsApi - object-oriented interface
 * @export
 * @class AttachedDocumentsApi
 * @extends {BaseAPI}
 */
export class AttachedDocumentsApi extends BaseAPI {
    /**
     * Use this endpoint to attach a PDF to Booked or Draft Entries.
     * @summary Attach PDF
     * @param {AttachedDocumentsApiAttachPdfAsyncRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof AttachedDocumentsApi
     */
    public attachPdfAsync(requestParameters: AttachedDocumentsApiAttachPdfAsyncRequest, options?: RawAxiosRequestConfig) {
        return AttachedDocumentsApiFp(this.configuration).attachPdfAsync(requestParameters.voucherNumber, requestParameters.accountingYear, requestParameters.file, requestParameters.number, requestParameters.note, requestParameters.pageCount, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AttachedDocumentsApi
     */
    public deleteAttachedDocumentById(requestParameters: AttachedDocumentsApiDeleteAttachedDocumentByIdRequest, options?: RawAxiosRequestConfig) {
        return AttachedDocumentsApiFp(this.configuration).deleteAttachedDocumentById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AttachedDocumentsApi
     */
    public getAllAttachedDocuments(requestParameters: AttachedDocumentsApiGetAllAttachedDocumentsRequest = {}, options?: RawAxiosRequestConfig) {
        return AttachedDocumentsApiFp(this.configuration).getAllAttachedDocuments(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AttachedDocumentsApi
     */
    public getAttachedDocumentById(requestParameters: AttachedDocumentsApiGetAttachedDocumentByIdRequest, options?: RawAxiosRequestConfig) {
        return AttachedDocumentsApiFp(this.configuration).getAttachedDocumentById(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AttachedDocumentsApi
     */
    public getNumberOfAttachedDocuments(requestParameters: AttachedDocumentsApiGetNumberOfAttachedDocumentsRequest = {}, options?: RawAxiosRequestConfig) {
        return AttachedDocumentsApiFp(this.configuration).getNumberOfAttachedDocuments(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AttachedDocumentsApi
     */
    public getPageOfAttachedDocuments(requestParameters: AttachedDocumentsApiGetPageOfAttachedDocumentsRequest = {}, options?: RawAxiosRequestConfig) {
        return AttachedDocumentsApiFp(this.configuration).getPageOfAttachedDocuments(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AttachedDocumentsApi
     */
    public getPdfForAttachedDocument(requestParameters: AttachedDocumentsApiGetPdfForAttachedDocumentRequest, options?: RawAxiosRequestConfig) {
        return AttachedDocumentsApiFp(this.configuration).getPdfForAttachedDocument(requestParameters.number, options).then((request) => request(this.axios, this.basePath));
    }
}
