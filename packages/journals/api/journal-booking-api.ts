...
// @ts-ignore
import type { BookingParameters } from '../model';
// @ts-ignore
import type { ProblemDetails } from '../model';
/**
 * JournalBookingApi - axios parameter creator
 * @export
 */
export const JournalBookingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Use this endpoint to book all draft entries in a journal.
         * @summary Book Entries
         * @param {number} journalNumber 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        bookEntriesWithinJournal: async (journalNumber: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'journalNumber' is not null or undefined
            assertParamExists('bookEntriesWithinJournal', 'journalNumber', journalNumber)
            const localVarPath = `/journals/{journalNumber}/book`
         ...
         * @summary Book Entries with date interval
         * @param {number} journalNumber 
         * @param {BookingParameters} [bookingParameters] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        bookEntriesWithinJournalWithDateInterval: async (journalNumber: number, bookingParameters?: BookingParameters, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'journalNumber' is not null or undefined
            assertParamExists('bookEntriesWithinJournalWithDateInterval', 'journalNumber', journalNumber)
            const localVarPath = `/journals/{journalNumber}/bookWithDateInterval`
                .replace(`{${"journalNumber"}}`, encodeURIComponent(String(journalNumber)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(bookingParameters, localVarRequestOptions, configuration)
...
/**
 * JournalBookingApi - functional programming interface
 * @export
 */
export const JournalBookingApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = JournalBookingApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to book all draft entries in a journal.
         * @summary Book Entries
         ...
         * @throws {RequiredError}
         */
        async bookEntriesWithinJournal(journalNumber: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.bookEntriesWithinJournal(journalNumber, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['JournalBookingApi.bookEntriesWithinJournal']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async bookEntriesWithinJournalWithDateInterval(journalNumber: number, bookingParameters?: BookingParameters, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.bookEntriesWithinJournalWithDateInterval(journalNumber, bookingParameters, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['JournalBookingApi.bookEntriesWithinJournalWithDateInterval']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * JournalBookingApi - factory interface
 * @export
 */
export const JournalBookingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = JournalBookingApiFp(configuration)
    return {
        /**
         * Use this endpoint to book all draft entries in a journal.
         * @summary Book Entries
         * @param {JournalBookingApiBookEntriesWithinJournalRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        bookEntriesWithinJournal(requestParameters: JournalBookingApiBookEntriesWithinJournalRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.bookEntriesWithinJournal(requestParameters.journalNumber, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to book draft entries contained in a time interval from a journal.
         * @summary Book Entries with date interval
         * @param {JournalBookingApiBookEntriesWithinJournalWithDateIntervalRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        bookEntriesWithinJournalWithDateInterval(requestParameters: JournalBookingApiBookEntriesWithinJournalWithDateIntervalRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.bookEntriesWithinJournalWithDateInterval(requestParameters.journalNumber, requestParameters.bookingParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for bookEntriesWithinJournal operation in JournalBookingApi.
 * @export
 * @interface JournalBookingApiBookEntriesWithinJournalRequest
 */
export interface JournalBookingApiBookEntriesWithinJournalRequest {
    /**
     * 
     * @type {number}
     * @memberof JournalBookingApiBookEntriesWithinJournal
     */
    readonly journalNumber: number
}

/**
 * Request parameters for bookEntriesWithinJournalWithDateInterval operation in JournalBookingApi.
 * @export
 * @interface JournalBookingApiBookEntriesWithinJournalWithDateIntervalRequest
 */
export interface JournalBookingApiBookEntriesWithinJournalWithDateIntervalRequest {
    /**
     * 
     * @type {number}
     * @memberof JournalBookingApiBookEntriesWithinJournalWithDateInterval
     */
    readonly journalNumber: number
     ...
     * @memberof JournalBookingApiBookEntriesWithinJournalWithDateInterval
     */
    readonly bookingParameters?: BookingParameters
}

/**
 * JournalBookingApi - object-oriented interface
 * @export
 * @class JournalBookingApi
 * @extends {BaseAPI}
 */
export class JournalBookingApi extends BaseAPI {
    /**
     * Use this endpoint to book all draft entries in a journal.
     * @summary Book Entries
     * @param {JournalBookingApiBookEntriesWithinJournalRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof JournalBookingApi
     */
    public bookEntriesWithinJournal(requestParameters: JournalBookingApiBookEntriesWithinJournalRequest, options?: RawAxiosRequestConfig) {
        return JournalBookingApiFp(this.configuration).bookEntriesWithinJournal(requestParameters.journalNumber, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof JournalBookingApi
     */
    public bookEntriesWithinJournalWithDateInterval(requestParameters: JournalBookingApiBookEntriesWithinJournalWithDateIntervalRequest, options?: RawAxiosRequestConfig) {
        return JournalBookingApiFp(this.configuration).bookEntriesWithinJournalWithDateInterval(requestParameters.journalNumber, requestParameters.bookingParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
