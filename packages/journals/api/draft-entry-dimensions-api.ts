...
// @ts-ignore
import type { DimensionData } from '../model';
// @ts-ignore
import type { DimensionDataCreatedResult } from '../model';
// @ts-ignore
import type { DimensionDataCursorResults } from '../model';
// @ts-ignore
import type { ProblemDetails } from '../model';
/**
 * DraftEntryDimensionsApi - axios parameter creator
 * @export
 */
export const DraftEntryDimensionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Use this endpoint to add new dimension to an existing draft entry
         * @summary Add dimensions to draft entry
         * @param {DimensionData} [dimensionData] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createDraftEntryDimension: async (dimensionData?: DimensionData, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/draft-entries/dimensions`;
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(dimensionData, localVarRequestOptions, configuration)
         ...
         * @summary Delete single Dimension
         * @param {DimensionData} [dimensionData] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteDimensionDataById: async (dimensionData?: DimensionData, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/draft-entries/dimensions`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
        ...
        /**
         * Use this endpoint to retrieve all the dimensions related to draft entries.
         * @summary Retrieve all Dimensions related to draft entries
         * @param {string} [cursor] 
         * @param {string} [filter] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllDraftEntriesDimensions: async (cursor?: string, filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/draft-entries/dimensions`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @summary Retrieve the number of Dimensions
         * @param {string} [filter] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfDraftEntryDimensions: async (filter?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/draft-entries/dimensions/count`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @summary Retrieve a page of Dimensions
         * @param {string} [filter] 
         * @param {string} [sort] 
         ...
         * @throws {RequiredError}
         */
        getPageOfDimensions: async (filter?: string, sort?: string, pageSize?: number, skipPages?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/draft-entries/dimensions/paged`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @summary Update existing dimension on a draft entry
         * @param {DimensionData} [dimensionData] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateDraftEntryDimension: async (dimensionData?: DimensionData, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/draft-entries/dimensions`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
/**
 * DraftEntryDimensionsApi - functional programming interface
 * @export
 */
export const DraftEntryDimensionsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = DraftEntryDimensionsApiAxiosParamCreator(configuration)
    return {
        /**
         * Use this endpoint to add new dimension to an existing draft entry
         * @summary Add dimensions to draft entry
         ...
         * @throws {RequiredError}
         */
        async createDraftEntryDimension(dimensionData?: DimensionData, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DimensionDataCreatedResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createDraftEntryDimension(dimensionData, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DraftEntryDimensionsApi.createDraftEntryDimension']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async deleteDimensionDataById(dimensionData?: DimensionData, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteDimensionDataById(dimensionData, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DraftEntryDimensionsApi.deleteDimensionDataById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to retrieve all the dimensions related to draft entries.
         ...
         * @throws {RequiredError}
         */
        async getAllDraftEntriesDimensions(cursor?: string, filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DimensionDataCursorResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllDraftEntriesDimensions(cursor, filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DraftEntryDimensionsApi.getAllDraftEntriesDimensions']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Call this endpoint to get the number of Dimensions. You can use filtering as well.
         ...
         * @throws {RequiredError}
         */
        async getNumberOfDraftEntryDimensions(filter?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<number>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getNumberOfDraftEntryDimensions(filter, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DraftEntryDimensionsApi.getNumberOfDraftEntryDimensions']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to load a page of Dimensions.
         ...
         * @throws {RequiredError}
         */
        async getPageOfDimensions(filter?: string, sort?: string, pageSize?: number, skipPages?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DimensionData>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPageOfDimensions(filter, sort, pageSize, skipPages, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DraftEntryDimensionsApi.getPageOfDimensions']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Use this endpoint to update an existing dimension on an draft entry
         ...
         * @throws {RequiredError}
         */
        async updateDraftEntryDimension(dimensionData?: DimensionData, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateDraftEntryDimension(dimensionData, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DraftEntryDimensionsApi.updateDraftEntryDimension']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
/**
 * DraftEntryDimensionsApi - factory interface
 * @export
 */
export const DraftEntryDimensionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = DraftEntryDimensionsApiFp(configuration)
    return {
        /**
         * Use this endpoint to add new dimension to an existing draft entry
         * @summary Add dimensions to draft entry
         * @param {DraftEntryDimensionsApiCreateDraftEntryDimensionRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createDraftEntryDimension(requestParameters: DraftEntryDimensionsApiCreateDraftEntryDimensionRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<DimensionDataCreatedResult> {
            return localVarFp.createDraftEntryDimension(requestParameters.dimensionData, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to delete a single Dimension by number.
         * @summary Delete single Dimension
         * @param {DraftEntryDimensionsApiDeleteDimensionDataByIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteDimensionDataById(requestParameters: DraftEntryDimensionsApiDeleteDimensionDataByIdRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteDimensionDataById(requestParameters.dimensionData, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to retrieve all the dimensions related to draft entries.
         * @summary Retrieve all Dimensions related to draft entries
         * @param {DraftEntryDimensionsApiGetAllDraftEntriesDimensionsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllDraftEntriesDimensions(requestParameters: DraftEntryDimensionsApiGetAllDraftEntriesDimensionsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<DimensionDataCursorResults> {
            return localVarFp.getAllDraftEntriesDimensions(requestParameters.cursor, requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Call this endpoint to get the number of Dimensions. You can use filtering as well.
         * @summary Retrieve the number of Dimensions
         * @param {DraftEntryDimensionsApiGetNumberOfDraftEntryDimensionsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getNumberOfDraftEntryDimensions(requestParameters: DraftEntryDimensionsApiGetNumberOfDraftEntryDimensionsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<number> {
            return localVarFp.getNumberOfDraftEntryDimensions(requestParameters.filter, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to load a page of Dimensions.
         * @summary Retrieve a page of Dimensions
         * @param {DraftEntryDimensionsApiGetPageOfDimensionsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPageOfDimensions(requestParameters: DraftEntryDimensionsApiGetPageOfDimensionsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<Array<DimensionData>> {
            return localVarFp.getPageOfDimensions(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(axios, basePath));
        },
        /**
         * Use this endpoint to update an existing dimension on an draft entry
         * @summary Update existing dimension on a draft entry
         * @param {DraftEntryDimensionsApiUpdateDraftEntryDimensionRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateDraftEntryDimension(requestParameters: DraftEntryDimensionsApiUpdateDraftEntryDimensionRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.updateDraftEntryDimension(requestParameters.dimensionData, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for createDraftEntryDimension operation in DraftEntryDimensionsApi.
 * @export
 * @interface DraftEntryDimensionsApiCreateDraftEntryDimensionRequest
 */
export interface DraftEntryDimensionsApiCreateDraftEntryDimensionRequest {
    /**
     * 
     * @type {DimensionData}
     * @memberof DraftEntryDimensionsApiCreateDraftEntryDimension
     */
    readonly dimensionData?: DimensionData
}

/**
 * Request parameters for deleteDimensionDataById operation in DraftEntryDimensionsApi.
 * @export
 * @interface DraftEntryDimensionsApiDeleteDimensionDataByIdRequest
 */
export interface DraftEntryDimensionsApiDeleteDimensionDataByIdRequest {
    /**
     * 
     * @type {DimensionData}
     * @memberof DraftEntryDimensionsApiDeleteDimensionDataById
     */
    readonly dimensionData?: DimensionData
}

/**
 * Request parameters for getAllDraftEntriesDimensions operation in DraftEntryDimensionsApi.
 * @export
 * @interface DraftEntryDimensionsApiGetAllDraftEntriesDimensionsRequest
 */
export interface DraftEntryDimensionsApiGetAllDraftEntriesDimensionsRequest {
    /**
     * 
     * @type {string}
     * @memberof DraftEntryDimensionsApiGetAllDraftEntriesDimensions
     */
...
/**
 * Request parameters for getNumberOfDraftEntryDimensions operation in DraftEntryDimensionsApi.
 * @export
 * @interface DraftEntryDimensionsApiGetNumberOfDraftEntryDimensionsRequest
 */
export interface DraftEntryDimensionsApiGetNumberOfDraftEntryDimensionsRequest {
    /**
     * 
     * @type {string}
     * @memberof DraftEntryDimensionsApiGetNumberOfDraftEntryDimensions
     */
    readonly filter?: string
}

/**
 * Request parameters for getPageOfDimensions operation in DraftEntryDimensionsApi.
 * @export
 * @interface DraftEntryDimensionsApiGetPageOfDimensionsRequest
 */
export interface DraftEntryDimensionsApiGetPageOfDimensionsRequest {
    /**
     * 
     * @type {string}
     * @memberof DraftEntryDimensionsApiGetPageOfDimensions
     */
    readonly filter?: string
...
/**
 * Request parameters for updateDraftEntryDimension operation in DraftEntryDimensionsApi.
 * @export
 * @interface DraftEntryDimensionsApiUpdateDraftEntryDimensionRequest
 */
export interface DraftEntryDimensionsApiUpdateDraftEntryDimensionRequest {
    /**
     * 
     * @type {DimensionData}
     * @memberof DraftEntryDimensionsApiUpdateDraftEntryDimension
     */
    readonly dimensionData?: DimensionData
}

/**
 * DraftEntryDimensionsApi - object-oriented interface
 * @export
 * @class DraftEntryDimensionsApi
 * @extends {BaseAPI}
 */
export class DraftEntryDimensionsApi extends BaseAPI {
    /**
     * Use this endpoint to add new dimension to an existing draft entry
     * @summary Add dimensions to draft entry
     * @param {DraftEntryDimensionsApiCreateDraftEntryDimensionRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof DraftEntryDimensionsApi
     */
    public createDraftEntryDimension(requestParameters: DraftEntryDimensionsApiCreateDraftEntryDimensionRequest = {}, options?: RawAxiosRequestConfig) {
        return DraftEntryDimensionsApiFp(this.configuration).createDraftEntryDimension(requestParameters.dimensionData, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DraftEntryDimensionsApi
     */
    public deleteDimensionDataById(requestParameters: DraftEntryDimensionsApiDeleteDimensionDataByIdRequest = {}, options?: RawAxiosRequestConfig) {
        return DraftEntryDimensionsApiFp(this.configuration).deleteDimensionDataById(requestParameters.dimensionData, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DraftEntryDimensionsApi
     */
    public getAllDraftEntriesDimensions(requestParameters: DraftEntryDimensionsApiGetAllDraftEntriesDimensionsRequest = {}, options?: RawAxiosRequestConfig) {
        return DraftEntryDimensionsApiFp(this.configuration).getAllDraftEntriesDimensions(requestParameters.cursor, requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DraftEntryDimensionsApi
     */
    public getNumberOfDraftEntryDimensions(requestParameters: DraftEntryDimensionsApiGetNumberOfDraftEntryDimensionsRequest = {}, options?: RawAxiosRequestConfig) {
        return DraftEntryDimensionsApiFp(this.configuration).getNumberOfDraftEntryDimensions(requestParameters.filter, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DraftEntryDimensionsApi
     */
    public getPageOfDimensions(requestParameters: DraftEntryDimensionsApiGetPageOfDimensionsRequest = {}, options?: RawAxiosRequestConfig) {
        return DraftEntryDimensionsApiFp(this.configuration).getPageOfDimensions(requestParameters.filter, requestParameters.sort, requestParameters.pageSize, requestParameters.skipPages, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DraftEntryDimensionsApi
     */
    public updateDraftEntryDimension(requestParameters: DraftEntryDimensionsApiUpdateDraftEntryDimensionRequest = {}, options?: RawAxiosRequestConfig) {
        return DraftEntryDimensionsApiFp(this.configuration).updateDraftEntryDimension(requestParameters.dimensionData, options).then((request) => request(this.axios, this.basePath));
    }
}
